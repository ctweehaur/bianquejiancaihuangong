const analysisData = [
    {
        header: "防微杜渐：正视危机与讳疾忌医的代价",
        headerPy: "fáng wēi dù jiàn zhèng shì wēi jī yǔ huì jí jì yī de dài jià",
        en: "Preventing Crises Early: The Dangerous Price of Ignoring Advice",
    ...
    }
    {
        ...
        en: "Key Linguistic Points: Loan Characters and Pronunciations",
        textZh: "本文中包含几个大马各类华文考试最常出现的考点字。比如“望桓侯而还走”中的“还”，必须读作“xuán”，它是“旋”的通假字，表示转身、掉转身体，不能误读为“hái”；“火齐之所及也”中的“齐”读作“jì”，通“剂”，指的是汤药剂。这些古汉语常识不仅是提分的核心，更是理解文言文时代特征的锁钥。",
        textPy: "huán zǒu de huán tōng xuán biǎo shì zhuǎn shēn huǒ jì de jì tōng jì biǎo shì yào jì zhè xiē gǔ hàn yǔ cháng shí jù bèi gāo dù de kǎo shí jià zhí",
        textEn: "There are major loan characters tested in high school exams. '还' (xuán) means to turn around quickly, while '齐' (jì) means liquid medicine recipes. Knowing these phonetic updates helps students perform well in classical translation texts."
    }
];
