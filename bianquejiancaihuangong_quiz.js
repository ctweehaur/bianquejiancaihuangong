const quizQuestions = [
    ...
    },
    {
        ...
        options: [
            ...
            { textStructure: [{w: "讳疾忌医", p: "huì jí jì yī"}], en: "Hiding one's illness and avoiding doctors.", correct: true, explanationStructure: [{w: "正确", p: "zhèng què"}, "，", {w: "比喻怕人", p: "bǐ yù pà rén"}, {w: "批评而", p: "pī píng ér"}, {w: "掩饰错误", p: "yǎn饰 cuò wù"}, "，", {w: "不愿接受", p: "bú yuàn jiē shòu"}, {w: "劝告", p: "quàn gào"}, "。"], explanationEn: "Correct. 'Huì jí jì yī' means hiding problems and refusing professional help because of pride, leading to total failure." },
